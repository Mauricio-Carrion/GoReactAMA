...
const markAsAnswered = `-- name: MarkAsAnswered :one
UPDATE
  "messages"
SET
  answered = true
...
func (q *Queries) MarkAsAnswered(ctx context.Context, id uuid.UUID) (bool, error) {
	row := q.db.QueryRow(ctx, markAsAnswered, id)
	var answered bool
